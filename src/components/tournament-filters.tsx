  ...
  return (
    <div className="flex flex-wrap items-start justify-between gap-3">
      <div className="flex flex-wrap gap-2">
        <Link href={buildHref({ region: activeRegion })} className="chip rounded-lg data-[active=true]:text-white" data-active={!activeStatus}>
          Tous statuts
        </Link>
      ...
      <div className="flex flex-wrap justify-end gap-2">
        <Link href={buildHref({ status: activeStatus })} className="chip rounded-lg data-[active=true]:text-white" data-active={!activeRegion}>
          Toutes régions
        </Link>
        {REGIONS.map((r) => (
          <Link
