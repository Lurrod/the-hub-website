...
const TOURNAMENTS: TournamentSeed[] = [
  ...
  },
  {
    ...
    status: "ONGOING",
    description:
      "Upper et lower bracket : il faut deux défaites pour sortir. Grande finale à venir.",
    prizePool: "25 000 €",
    bestOf: 3,
    teams: [0, 1, 2, 3, 4, 5, 6, 7],
    startDay: 10,
  ...
  },
  {
    ...
    status: "FINISHED",
    description:
      "Deux poules de quatre, chaque équipe affronte les trois autres. Classement par points.",
    prizePool: "5 000 €",
    bestOf: 3,
    groupSize: 4,
    teams: [0, 1, 2, 3, 4, 5, 6, 7],
  ...
  },
  {
    ...
    status: "ONGOING",
    description:
      "Phase de poules qualificative, les deux premiers de chaque groupe rejoignent les playoffs.",
    prizePool: "40 000 €",
    bestOf: 3,
    groupSize: 4,
    teams: [0, 1, 2, 3, 4, 5, 6, 7],
  ...
  },
  {
    ...
    status: "ONGOING",
    description:
      "Trois rondes appariées par score, sans élimination directe. La dernière ronde reste à jouer.",
    prizePool: "8 000 €",
    bestOf: 1,
    teams: [0, 1, 2, 3, 4, 5, 6, 7],
  ...
  },
  {
    ...
    status: "FINISHED",
    description:
      "Six équipes, toutes s'affrontent une fois, classement global sur l'ensemble des matchs.",
    prizePool: "6 000 €",
    bestOf: 3,
    teams: [0, 1, 2, 3, 4, 5],
    ...
    matches: groupMatches(
      { key: "rr", name: "Classement général", teams: [0, 1, 2, 3, 4, 5] },
      -60
    ),
  },
  {
  ...
  {
    id: "fmt-premier-invite",
    name: "Premier Invite - Playoffs",
    format: "PREMIER_INVITE",
    status: "FINISHED",
    description:
      "Playoffs de la division Invite : huit équipes, une défaite et c'est fini. Bo1 jusqu'à la finale, jouée en Bo3.",
    prizePool: "Qualification Challengers",
    bestOf: 1,
    teams: [0, 1, 2, 3, 4, 5, 6, 7],
    startDay: 20,
    endDay: 20,
  ...
  {
    id: "fmt-premier-contender",
    name: "Premier Contender - Playoffs",
    format: "PREMIER_CONTENDER",
    status: "FINISHED",
    description:
      "Playoffs de la division Contender : trop d'équipes qualifiées pour un seul arbre, deux brackets sont tirés en parallèle.",
    prizePool: "Montée en Invite",
    bestOf: 1,
    teams: [0, 1, 2, 3, 4, 5, 6, 7],
    startDay: 21,
    endDay: 21,
    groups: [
      { key: "ba", name: "Bracket A", teams: [0, 1, 2, 3] },
      { key: "bb", name: "Bracket B", teams: [4, 5, 6, 7] },
    ],
    matches: [
      {
        key: "a-sf1",
